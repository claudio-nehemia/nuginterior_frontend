...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-[520px] relative z-10 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.1)] border-white/40 bg-white/80 backdrop-blur-xl rounded-[2rem] overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.1em] ml-1">NIK (16 digit)</label>
                    <Input 
                      type="text" 
                      name="ceoNik"
